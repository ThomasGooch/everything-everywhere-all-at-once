...
class TestTaskManager:
    ...
    @pytest.mark.asyncio
    async def test_get_task_success(self, task_manager, mock_plugin_registry, sample_task_data):
    ...
    @pytest.mark.asyncio
    async def test_update_task_progress_success(self, task_manager, mock_plugin_registry, sample_progress):
    ...
    @pytest.mark.asyncio
    async def test_update_task_progress_failure(self, task_manager, mock_plugin_registry, sample_progress):
    ...
    @pytest.mark.asyncio
    async def test_assign_task_success(self, task_manager, mock_plugin_registry, sample_task_data):
    ...
    @pytest.mark.asyncio
    async def test_handle_task_completion_success(self, task_manager, mock_plugin_registry):
    ...
    @pytest.mark.asyncio
    async def test_handle_task_completion_with_failures(self, task_manager, mock_plugin_registry):
    ...
    @pytest.mark.asyncio
    async def test_get_task_status_success(self, task_manager, mock_plugin_registry, sample_task_data):
    ...
    async def test_calculate_task_duration(self, task_manager):
        ...
        assert duration.total_seconds() <= 9600  # At most 2.67 hours (allowing for test execution time)
    ...
    @pytest.mark.asyncio
    async def test_task_manager_error_handling(self, task_manager, mock_plugin_registry):
