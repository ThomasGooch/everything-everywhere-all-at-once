...
class TestCodebaseScanner:
    ...
    @pytest.mark.asyncio
    async def test_detect_tech_stack_python_fastapi(self, codebase_scanner, temp_repository):
    ...
    @pytest.mark.asyncio
    async def test_identify_architecture_pattern(self, codebase_scanner, temp_repository):
    ...
    async def test_list_dependencies_python(self, codebase_scanner, temp_repository):
        ...
        dep_names = [dep.name for dep in dependencies if isinstance(dep, DependencyInfo)]
    ...
    async def test_detect_test_framework(self, codebase_scanner, temp_repository):
        ...
        assert any(pattern.endswith('.py') for pattern in test_framework.test_file_patterns)
    ...
    @pytest.mark.asyncio
    async def test_identify_configuration_files(self, codebase_scanner, temp_repository):
        """Test configuration file identification"""
        config_files = await codebase_scanner.identify_configuration_files(temp_repository)
    ...
    async def test_analyze_imports_and_usage(self, codebase_scanner, temp_repository):
        ...
        usage_analysis = await codebase_scanner.analyze_imports_and_usage(temp_repository)
