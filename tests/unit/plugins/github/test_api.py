...
class TestGitHubAPI:
    ...
    def test_clone_repository_success(self, mock_exists, mock_subprocess, mock_rmtree, mock_from_env):
    ...
    @patch('subprocess.run')
    @patch('pathlib.Path.exists')
    def test_clone_repository_failure(self, mock_exists, mock_subprocess, mock_from_env):
    ...
    def test_generate_commit_message(self, mock_from_env):
        ...
        api = GitHubAPI()
        message = api.generate_commit_message("TASK-123", "Implement user authentication")
