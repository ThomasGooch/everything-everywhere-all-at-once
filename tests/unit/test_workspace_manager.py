...
class TestWorkspaceManager:
    ...
    async def test_get_workspace_success(self, workspace_manager):
        ...
        created_workspace = await workspace_manager.create_workspace(agent_id, repository_url)
    ...
    async def test_cleanup_workspace_success(self, workspace_manager):
        ...
        # Cleanup workspace
        result = await workspace_manager.cleanup_workspace(agent_id, preserve_logs=False)
