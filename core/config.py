...
class WorkspaceConfig(BaseModel):
    ...
    base_path: str = Field(default="/tmp/ai-orchestrator-workspaces", description="Base workspace directory")
...
class Settings(BaseSettings):
    ...
    app_name: str = Field(default="AI Development Orchestrator", description="Application name")
